...
var uuid = await _firebase.db.collection('votes').doc();
...
$root.addEventListener('click', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
    var _find, _document$querySelect;
    var voteId, title, deadline, voteType, user, data;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            e.preventDefault();
            voteId = (_find = _toConsumableArray($root.querySelectorAll('.vote-type')).find(function (type) {
              return type.checked;
            })) === null || _find === void 0 ? void 0 : _find.id;
            title = $root.querySelector('.vote-title').value;
            deadline = $root.querySelector('.deadline').value;
            voteType = (_document$querySelect = document.querySelector("label[for=".concat(voteId, "]"))) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.textContent;
          ...
          case 10:
            ...
            uuid.set(_objectSpread({
              owner: user,
              id: uuid.id
            }, data));
            _firebase.db.collection('users').doc(user).collection('voteList').doc(uuid.id).set({});
            _context2.next = 17;
            return _firebase.db.collection('votes').doc();
          case 17:
            uuid = _context2.sent;
